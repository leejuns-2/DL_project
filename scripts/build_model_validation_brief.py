...
def build_brief() -> str:
    ...
    lines = [
        ...
        *_markdown_table(
        ...
        "따라서 발표에서는 단일 라벨 분류기라기보다 복합 보고서를 시장 신호로 요약하는 도구라고 설명하는 것이 안전합니다.",
        "",
        "## OOD 점검",
        "",
        *_markdown_table(
        ...
        *_markdown_table(
        ...
        "## 완성도 판단",
        "",
        "현재 완성도는 연구 프로젝트 기준 약 80점 수준으로 평가할 수 있습니다. "
        "기능 흐름과 배포, baseline 비교, 실패 분석은 갖췄고, 남은 보완은 더 큰 라벨 데이터셋, 복합 주제 판정, OOD 전용 classifier입니다.",
        "",
        "## 발표용 안전 문장",
        "",
