...
def build_brief() -> str:
    ...
    lines = [
        ...
        "## 한줄 평가",
        "",
        f"현재 모델은 연구용 MVP로는 동작하지만, 검증 PDF {total}개는 통계적 일반화 평가로 보기에는 작습니다. "
        "따라서 현재 수치는 pilot dominant-theme alignment로만 해석하고, 문단 단위 multi-label 평가셋과 OOD 전용 평가를 확장해야 합니다.",
        "",
        "## 방법론 정의",
        "",
